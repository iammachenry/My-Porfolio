...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <meta name="description" content="Salesforce Implementation Consultant & Administrator | 6X Salesforce Certified Professional delivering measurable results: 108% lead conversion increase, 71% faster case resolution, 95% forecast accuracy. Specializing in Sales Cloud, Service Cloud, CRM optimization, and customer experience transformation.">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="text-white" data-aos="fade-right">
                        <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                            Salesforce Implementation Consultant & Administrator helping organizations <span class="text-yellow-300">scale operations, optimize CRM systems, and elevate customer experience</span> through secure, scalable solutions.
                        </h1>
                        <p class="text-xl mb-4 text-green-100 font-semibold">
                            6X Salesforce Certified | Salesforce Admin & Implementation | CX Specialist | CRM Expert | 7+ Years Experience
                        </p>
