  ...
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 pb-20 pt-32">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex justify-center mb-8" data-aos="fade-down">
                        <img 
                            ...
                            class="w-64 md:w-80 rounded-2xl shadow-2xl border-4 border-white/30"
                        />
                    </div>

                    <!-- Dramatic Multi-line Headline - MORE PERSONAL -->
                    <h1 class="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white max-w-5xl text-center mx-auto" data-aos="fade-up" data-aos-delay="100">
                        I Help Growing Businesses<br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-100">Scale Operations with Enterprise-Grade</span><br>
                        <span class="text-blue-100">Salesforce Solutions</span>
                    </h1>
                    
                    <!-- Tightened Value Sentence - ACTION-ORIENTED -->
                    <p class="text-lg md:text-xl lg:text-2xl mb-8 leading-relaxed text-white max-w-4xl text-center mx-auto px-4" data-aos="fade-up" data-aos-delay="200">
                        Certified Salesforce professional helping businesses streamline operations, automate workflows, and improve customer experience.
                    </p>
                    
                    <!-- WHO I HELP - Clear Qualifier -->
                    <p class="text-base md:text-lg mb-12 leading-relaxed text-green-100 max-w-3xl text-center mx-auto px-4" data-aos="fade-up" data-aos-delay="250">
                        I work with startups, SMEs, and growing teams to automate sales, support, and customer workflows using Salesforce.
                    </p>
                    
                    <!-- Two Primary CTAs -->
                    <div class="flex flex-wrap gap-6 justify-center" data-aos="fade-up" data-aos-delay="300">
                        <a href="#completed-projects" class="bg-white text-green-700 px-10 py-5 rounded-lg text-lg font-semibold inline-flex items-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                        ...
                        <a href="https://drive.google.com/file/d/1srpFAplJVJj4yO4mg4zWlYO2IfZdG-Ra/view?usp=sharing" 
                           target="_blank"
                           rel="noopener noreferrer"
                           class="bg-blue-600 text-white px-10 py-5 rounded-lg text-lg font-semibold inline-flex items-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
                    <a href="#proven-results" class="text-white/70 hover:text-white transition">
