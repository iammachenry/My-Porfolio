                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="order-2 md:order-1">
                            ...
                            <p class="text-lg sm:text-xl md:text-2xl mb-8 text-white/90 leading-relaxed">
                                I'm <span class="text-yellow-300">Henry Imafidon</span>, a certified <span class="text-yellow-300">Salesforce Admin & Implementation Consultant</span> and <span class="text-yellow-300">CX professional</span> who transforms complex business challenges into <span class="text-yellow-300">streamlined, scalable solutions</span> that drive measurable results.
                            </p>
                ...
                <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 border-2 border-blue-100">
                    ...
                    <div class="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            This diagram shows how I implemented <strong>Sales Cloud and Service Cloud</strong> working together with external systems (like marketing tools and payment platforms). It demonstrates my hands-on experience with <strong>data integration, user security setup, and process automation</strong>—core Salesforce Admin skills I've built over 2+ years.
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div data-aos="fade-right">
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                I help organizations of all sizes <strong>optimize their Salesforce, CRM operations, and customer experience</strong> by designing <strong>automated workflows, secure data models, and data-driven processes</strong> that increase efficiency by up to 40%, reduce manual effort, and support scalable growth—whether you're a startup or an enterprise.
                            </p>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl p-8 card-hover border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p class="text-gray-600 mb-6">
                            Built Flows to automate repetitive tasks like record updates, email alerts, and approvals—saving teams time and reducing manual errors.
                        </p>
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-start text-sm text-gray-700">
                                <i class="fas fa-check text-green-600 mt-1 mr-2"></i>
                            ...
                            <div>
                                ...
                                <div class="mb-6 bg-red-50 p-5 rounded-lg border-l-4 border-red-500">
                                    ...
                                    <ul class="space-y-2 text-gray-700">
                                        ...
                                        <li class="flex items-start">
                                            <i class="fas fa-times-circle text-red-500 mt-1 mr-2 flex-shrink-0"></i>
                                            <span>Support cases tracked manually—average resolution time of 3.5 days</span>
                                        </li>
                                        <li class="flex items-start">
                                            <i class="fas fa-times-circle text-red-500 mt-1 mr-2 flex-shrink-0"></i>
                                ...
                                <div class="mb-6 bg-green-50 p-5 rounded-lg border-l-4 border-green-600">
                                    ...
                                    <p class="text-gray-700 mb-3 leading-relaxed">
                                        Implemented an integrated Sales Cloud and Service Cloud system with automated lead routing, real-time forecasting dashboards, and SLA-based case management—giving leadership complete visibility and enabling consistent processes across all regions.
                                    </p>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <ul class="space-y-2 text-gray-700 text-sm">
                                        ...
                                        <li class="flex items-start">
                                            <i class="fas fa-check text-blue-600 mt-1 mr-3 flex-shrink-0"></i>
                                            <span><strong>Automated lead scoring and routing</strong>—ensured hot leads reached the right rep within minutes</span>
                                        </li>
                                        <li class="flex items-start">
                                            <i class="fas fa-check text-blue-600 mt-1 mr-3 flex-shrink-0"></i>
                                            <span><strong>Real-time executive dashboards</strong>—gave leadership visibility into forecasts, pipeline, and support performance</span>
                                        </li>
                                        <li class="flex items-start">
                                            <i class="fas fa-check text-blue-600 mt-1 mr-3 flex-shrink-0"></i>
                                            <span><strong>SLA tracking with early warnings</strong>—prevented violations before they happened</span>
                                        </li>
                                        <li class="flex items-start">
                                            <i class="fas fa-check text-blue-600 mt-1 mr-3 flex-shrink-0"></i>
                                            <span><strong>User training and change management</strong>—ensured adoption across 50+ users in 4 departments</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <!-- Business Impact -->\n                                <div class="mt-6 p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border-2 border-green-500">
                                    ...
                                    <ul class="text-sm text-gray-700 space-y-2">
                                        ...
                                        <li class="flex items-start">
                                            <i class="fas fa-check-circle text-green-600 mt-1 mr-2 flex-shrink-0"></i>
                                            <span>Eliminated 15+ hours/week of manual work—teams focused on customers, not spreadsheets</span>
                                        </li>
                                        <li class="flex items-start">
                                            <i class="fas fa-check-circle text-green-600 mt-1 mr-2 flex-shrink-0"></i>
                                            <span>Created scalable foundation that supported expansion to 3 new territories</span>
                                        </li>
                                    </ul>
                                </div>
