        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32">
                ...
                <div class="inline-block mb-6" data-aos="fade-down">
                    <div class="bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 rounded-full px-6 py-3 shadow-2xl badge-glow">
                        <div class="flex items-center space-x-3">
                            <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                                <i class="fas fa-cloud text-blue-600 text-base"></i>
                            </div>
                            <span class="text-white font-bold text-lg">6X Salesforce Certified</span>
                        </div>
                    </div>
                </div>

                <!-- Dramatic Multi-line Headline -->
                <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight text-white" data-aos="fade-up">
                    I Design & Implement<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400">Enterprise-Grade Salesforce Solutions</span><br>
                    <span class="text-yellow-300">That Scale Operations & Elevate Customer Experience</span>
                </h1>
                
                <!-- Brief Value Sentence -->
                <p class="text-xl md:text-2xl mb-12 leading-relaxed text-white/90 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                    Certified Salesforce professional helping businesses streamline operations and deliver better customer experiences.
                </p>
                
                <!-- Two Primary CTAs -->
                <div class="flex flex-wrap gap-6 justify-center" data-aos="fade-up" data-aos-delay="200">
                    <a href="#completed-projects" class="bg-gradient-to-r from-green-500 to-blue-600 text-white px-10 py-5 rounded-lg text-lg font-semibold inline-flex items-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                    ...
                    <a href="https://drive.google.com/file/d/1srpFAplJVJj4yO4mg4zWlYO2IfZdG-Ra/view?usp=sharing" 
                       target="_blank"
                       rel="noopener noreferrer"
                       class="bg-white text-gray-900 px-10 py-5 rounded-lg text-lg font-semibold inline-flex items-center hover:bg-gray-100 transition shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <!-- Scroll Indicator -->
                <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce" data-aos="fade-up" data-aos-delay="300">
