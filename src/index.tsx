...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <meta name="description" content="6X Salesforce Certified Professional specializing in Salesforce Administration, CRM Implementation, and Customer Experience. Helping organizations optimize operations and increase efficiency by up to 40%.">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="text-white" data-aos="fade-right">
                        <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                            6X Salesforce Certified Professional helping organizations optimize <span class="text-yellow-300">Salesforce, CRM, and Customer Experience</span> with secure, scalable solutions.
                        </h1>
                        <p class="text-xl mb-4 text-green-100 font-semibold">
                            Salesforce Admin | Implementation Consultant | CX Specialist | CRM Expert | 7+ Years Experience
                        </p>
                        <p class="text-lg mb-8 leading-relaxed text-green-50">
                            I help organizations of all sizes transform their operations through <strong>Salesforce Administration, CRM Implementation, Process Automation, and Customer Experience optimization</strong>. My work focuses on building scalable solutions, secure data models, and automation that improves efficiency, accuracy, and customer satisfaction.
                        </p>
