                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-2" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <a href="https://drive.google.com/file/d/1srpFAplJVJj4yO4mg4zWlYO2IfZdG-Ra/view?usp=sharing" 
                           target="_blank"
                           rel="noopener noreferrer"
                           class="bg-blue-600 text-white px-5 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-lg text-sm sm:text-base md:text-lg font-semibold inline-flex items-center justify-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
                            <i class="fas fa-file-alt mr-2"></i>
                            Download Resume
                        </a>
                    </div>
