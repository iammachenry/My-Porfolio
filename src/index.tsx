            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-white text-center max-w-5xl mx-auto" data-aos="fade-up">
                    ...
                    <p class="text-lg md:text-xl mb-8 leading-relaxed text-green-50 max-w-3xl mx-auto">
                        I'm <strong class="text-white font-bold">Henry Imafidon</strong>, a Salesforce Administrator and Implementation Specialist who bridges the gap between business operations and scalable technology solutions, helping organizations transform their CRM systems into strategic assets that drive growth and exceptional customer experiences.
                    </p>
