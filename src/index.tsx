                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="text-white" data-aos="fade-right">
                        <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                            Salesforce Administrator & Implementation Consultant helping organizations transform <span class="text-yellow-300">sales and service operations</span> with secure, scalable Salesforce solutions.
                        </h1>
                        <p class="text-xl mb-4 text-green-100 font-semibold">
                            6X Salesforce Certified | Admin, Implementation & CX Specialist | 7+ years Customer Experience
                        </p>
                        <p class="text-lg mb-8 leading-relaxed text-green-50">
                            I help organizations of all sizes design and implement Salesforce solutions that align people, processes, and technology. My expertise spans Administration, Implementation, and Customer Experience—building scalable data models, secure access controls, and automation that improves adoption, reporting accuracy, and operational efficiency.
                        </p>
                    ...
                    <div data-aos="fade-right">
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                I help organizations of all sizes <strong>transform their Salesforce operations</strong> and enhance customer experience by designing <strong>automated workflows and data-driven processes</strong> that increase efficiency by up to 40%, reduce manual effort, and support scalable growth—whether you're a startup or an enterprise.
                            </p>
                        </div>
                    </div>
