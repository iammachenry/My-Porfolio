            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-white text-center max-w-5xl mx-auto" data-aos="fade-up">
                    ...
                    <p class="text-lg md:text-xl mb-8 leading-relaxed text-green-50 max-w-3xl mx-auto">
                        I'm <strong class="text-white font-bold">Henry Imafidon</strong>, a certified Salesforce Administrator, Implementation Consultant & CX Specialist who turns operational complexity into competitive advantage.
                    </p>
