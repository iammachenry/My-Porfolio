...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <meta name="description" content="Salesforce Administrator, Implementation Specialist & CX Expert building scalable CRM solutions. 6X Certified professional delivering 108% lead conversion increase, 71% faster case resolution, 95% forecast accuracy. Sales Cloud, Service Cloud, Process Automation specialist.">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-8" data-aos="fade-down">
                    <div class="inline-block">
                        <div class="relative">
                            <!-- Professional Photo - Medium Size -->
                            <div class="w-40 h-40 md:w-48 md:h-48 mx-auto rounded-full overflow-hidden border-4 border-white/20 shadow-2xl floating">
                                <img src="/static/henry-dashboard-photo.jpg" 
                                     alt="Henry Imafidon - Salesforce Administrator & Implementation Specialist" 
                                     class="w-full h-full object-cover">
                            </div>
                            <!-- Floating Badge -->
                            <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-white rounded-full px-4 py-2 shadow-xl">
                                <div class="flex items-center space-x-2">
                                    <div class="w-6 h-6 bg-gradient-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center">
                                        <i class="fas fa-cloud text-white text-xs"></i>
                                    </div>
                                    <span class="text-gray-900 font-bold text-xs">6X Certified</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-white text-center max-w-5xl mx-auto" data-aos="fade-up">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                        <span class="text-yellow-300">Salesforce Administrator, Implementation Specialist & CX Expert</span> Building Scalable CRM Solutions
                    </h1>
