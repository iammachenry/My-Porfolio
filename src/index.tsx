                    ...
                    <div data-aos="fade-left">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                            ...
                            <div class="certification-badge rounded-xl p-4 text-center relative overflow-hidden group bg-white shadow-lg hover:shadow-xl transition">
                                <img src="https://www.genspark.ai/api/files/s/sPNkItzs" alt="Platform Administrator" class="w-24 h-24 mx-auto mb-2">
                                <h4 class="font-bold text-gray-900 text-xs">Platform Administrator</h4>
                            </div>
                            
                            <!-- Badge 2: Sales Cloud Consultant -->
                            <div class="certification-badge rounded-xl p-4 text-center relative overflow-hidden group bg-white shadow-lg hover:shadow-xl transition">
                                <img src="https://www.genspark.ai/api/files/s/By8TtzyL" alt="Sales Cloud Consultant" class="w-24 h-24 mx-auto mb-2">
                                <h4 class="font-bold text-gray-900 text-xs">Sales Cloud Consultant</h4>
                            </div>
                            
                            <!-- Badge 3: Service Cloud Consultant -->
                            <div class="certification-badge rounded-xl p-4 text-center relative overflow-hidden group bg-white shadow-lg hover:shadow-xl transition">
                                <img src="https://www.genspark.ai/api/files/s/djtLhvv0" alt="Service Cloud Consultant" class="w-24 h-24 mx-auto mb-2">
                                <h4 class="font-bold text-gray-900 text-xs">Service Cloud Consultant</h4>
                            </div>
                            
                            <!-- Badge 4: Platform Foundations -->
                            <div class="certification-badge rounded-xl p-4 text-center relative overflow-hidden group bg-white shadow-lg hover:shadow-xl transition">
                                <img src="https://www.genspark.ai/api/files/s/kMTQ2pRF" alt="Platform Foundations" class="w-24 h-24 mx-auto mb-2">
                                <h4 class="font-bold text-gray-900 text-xs">Platform Foundations</h4>
                            </div>
                            
                            <!-- Badge 5: AI Associate -->
                            <div class="certification-badge rounded-xl p-4 text-center relative overflow-hidden group bg-white shadow-lg hover:shadow-xl transition">
                                <img src="https://www.genspark.ai/api/files/s/vF85OCOi" alt="AI Associate" class="w-24 h-24 mx-auto mb-2">
                                <h4 class="font-bold text-gray-900 text-xs">AI Associate</h4>
                            </div>
                            
                            <!-- Badge 6: Agentforce Specialist -->
                            <div class="certification-badge rounded-xl p-4 text-center relative overflow-hidden group bg-white shadow-lg hover:shadow-xl transition">
                                <img src="https://www.genspark.ai/api/files/s/LWdnYgOv" alt="Agentforce Specialist" class="w-24 h-24 mx-auto mb-2">
