                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="text-white" data-aos="fade-right">
                        ...
                        <p class="text-xl mb-4 text-green-100 font-semibold">
                            6X Salesforce Certified | Sales & Service Cloud | Process Automation | 7+ Years Experience
                        </p>
                    ...
                    <div class="relative" data-aos="fade-left">
                        <!-- Professional Photo with Salesforce Dashboard Background -->
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 class="text-gray-900 font-bold text-base">Henry Imafidon</h3>
                                                <p class="text-gray-600 text-sm">6X Salesforce Certified Professional</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-6 space-y-4">
                                    <div class="bg-white/10 rounded-lg p-3">
                                        <div class="flex justify-between items-center mb-2">
                                            <span class="text-white text-sm font-semibold">CRM Optimization</span>
                                    ...
                                    <div class="bg-white/10 rounded-lg p-3">
                                        <div class="flex justify-between items-center mb-2">
                                            <span class="text-white text-sm font-semibold">Process Automation</span>
                                    ...
                                    <div class="bg-white/10 rounded-lg p-3">
                                        <div class="flex justify-between items-center mb-2">
                                            <span class="text-white text-sm font-semibold">Implementation Success</span>
