...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <meta name="description" content="Transforming CRM, Salesforce & Customer Experience into Scalable Growth Systems. 6X Certified Implementation Consultant delivering 108% lead conversion increase, 71% faster case resolution, 95% forecast accuracy. Sales Cloud, Service Cloud, Process Automation expert.">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="text-white" data-aos="fade-right">
                        <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                            Transforming <span class="text-yellow-300">CRM, Salesforce & Customer Experience</span> into Scalable Growth Systems
                        </h1>
                        <p class="text-xl mb-4 text-green-100 font-semibold">
                            6X Salesforce Certified | Implementation Consultant & Administrator | 7+ Years Experience
                        </p>
