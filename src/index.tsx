...
app.get('/', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <!-- Hero Section - Full Dashboard Image (No Overlays - Image Has Everything) -->
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 to-blue-900">
            <!-- Full Salesforce Dashboard Image - Contains Photo, Badge, Headline, CTAs -->
            <img 
            ...
            <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce z-20">
                <a href="#proven-results" class="text-white/90 hover:text-white transition drop-shadow-2xl">
