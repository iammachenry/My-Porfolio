  ...
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-3 sm:px-6 lg:px-8 py-12 pt-20 md:pt-32 pb-20">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="flex flex-col justify-center order-2 lg:order-1" data-aos="fade-right">
                            ...
                            <h1 class="text-lg sm:text-xl md:text-2xl lg:text-4xl mb-3 md:mb-5 leading-tight text-white font-bold text-center lg:text-left">
                            ...
                            <p class="text-sm sm:text-base md:text-lg lg:text-xl mb-5 md:mb-7 leading-relaxed text-white font-medium text-center lg:text-left">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                                <a href="#contact" class="bg-white text-green-700 px-6 py-3 sm:px-7 sm:py-4 rounded-lg text-base sm:text-base md:text-lg font-bold inline-flex items-center justify-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                                    <i class="fas fa-comments mr-2 hidden sm:inline"></i>
                                    Get In Touch
                                </a>
                                <a href="#completed-projects" class="bg-blue-600 text-white px-6 py-3 sm:px-7 sm:py-4 rounded-lg text-base sm:text-base md:text-lg font-bold inline-flex items-center justify-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
                        ...
                        <div class="flex justify-center lg:justify-start order-1 lg:order-2" data-aos="fade-left">
                            <img 
                                ...
                                class="w-64 sm:w-72 md:w-80 lg:w-96 rounded-2xl shadow-2xl border-4 border-white/30"
                            />
                        </div>
