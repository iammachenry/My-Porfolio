            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 md:p-8 mb-8 border-2 border-white/20" data-aos="fade-up">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- WhatsApp -->
                        <a href="https://wa.me/2349061453199" target="_blank" rel="noopener noreferrer" class="flex items-center space-x-4 text-white hover:text-yellow-300 transition group">
                            <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-white/30 transition">
                                <i class="fab fa-whatsapp text-xl"></i>
                            </div>
                            <div>
                                <p class="text-sm text-green-100">WhatsApp</p>
                                <p class="font-semibold">+234 906 145 3199</p>
                            </div>
                        </a>
                    ...
                    <div class="mt-6 pt-6 border-t border-white/20">
                        <a href="https://x.com/iammachenry" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center space-x-3 text-white hover:text-yellow-300 transition group">
                            <div class="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-white/30 transition">
                                <i class="fab fa-x-twitter"></i>
                            </div>
                            <span class="font-semibold">@IAMMACHENRY</span>
                        </a>
                    </div>
                </div>
