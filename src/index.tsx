            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-white text-center max-w-5xl mx-auto" data-aos="fade-up">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 leading-tight">
                        <span class="text-white">Building Enterprise-Grade</span><br>
                        <span class="text-white">Salesforce Solutions That Scale</span><br>
                        <span class="text-yellow-300">Operations & Elevate CX</span>
                    </h1>
                    
                    <!-- Brief Intro About You -->
                    <p class="text-lg md:text-xl mb-8 leading-relaxed text-green-50 max-w-3xl mx-auto">
                        I'm <strong class="text-white font-bold">Henry Imafidon</strong>, a 6X Salesforce Certified Administrator and Implementation Specialist who bridges the gap between business operations and scalable technology solutions. With 7+ years of experience, I help organizations transform their CRM systems into strategic assets that drive growth and exceptional customer experiences.
                    </p>
