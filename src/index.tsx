        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-3 sm:px-6 lg:px-8 py-16 pt-20 md:pt-32">
                <div class="max-w-7xl mx-auto">
                    ...
                    <p class="text-sm sm:text-base md:text-lg lg:text-xl mb-8 md:mb-12 leading-relaxed text-white max-w-3xl text-center mx-auto px-2 font-medium" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="mt-8 md:mt-16 flex justify-center">
                    <a href="#proven-results" class="text-white hover:text-yellow-300 transition animate-bounce">
