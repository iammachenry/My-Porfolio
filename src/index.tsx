...
app.get('/', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <section id="home" class="relative pt-32 pb-20 mt-20 overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <!-- Hero Content Overlay - TWO COLUMN LAYOUT (TEXT LEFT, PHOTO RIGHT - EXACT FRIEND'S LAYOUT) -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="order-2 md:order-1">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="#contact" class="bg-white text-green-700 px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition transform hover:scale-105">
                                    Get In Touch
                                </a>
                                <a href="#completed-projects" class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition transform hover:scale-105">
                                    View Projects
                                </a>
                            </div>
                        </div>
