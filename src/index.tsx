                ...
                <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 border-2 border-blue-100">
                    ...
                    <div class="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            This architecture represents a <strong>multi-cloud enterprise implementation</strong> I designed, connecting Sales Cloud and Service Cloud with external systems (marketing platforms, email services, payment gateways). It demonstrates my ability to architect <strong>secure, scalable solutions</strong> with proper data flow, role-based security, and automated workflows—skills critical for senior Salesforce roles.
                        </p>
                    </div>
