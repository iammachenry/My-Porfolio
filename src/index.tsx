  ...
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <!-- Hero Content Overlay - TWO COLUMN LAYOUT (PHOTO LEFT, CONTENT RIGHT) -->
            <div class="relative z-10 w-full px-3 sm:px-6 lg:px-8 py-16 pt-20 md:pt-32">
                <div class="max-w-7xl mx-auto">
                    <!-- Two Column Grid: Photo Left, Content Right -->
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="flex flex-col justify-center" data-aos="fade-left">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                                <a href="#completed-projects" class="bg-white text-green-700 px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-sm sm:text-base md:text-lg font-semibold inline-flex items-center justify-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                                    <i class="fas fa-folder-open mr-2"></i>
                                    View Projects
                                </a>
                                <a href="#services" class="bg-blue-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-sm sm:text-base md:text-lg font-semibold inline-flex items-center justify-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
