            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-8" data-aos="fade-down">
                    <div class="inline-block">
                        <div class="relative">
                            ...
                            <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 rounded-full px-6 py-3 shadow-2xl badge-glow">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                                        <i class="fas fa-cloud text-blue-600 text-base"></i>
                                    </div>
                                    <span class="text-white font-bold text-base">6X Salesforce Certified</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-white text-center max-w-5xl mx-auto" data-aos="fade-up">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                        <span class="text-yellow-300">Building Scalable Solutions for CRM, Operations & Customer Experience</span>
                    </h1>
                    <p class="text-xl md:text-2xl mb-4 text-green-100 font-semibold">
                        Henry Imafidon
                    </p>
                    <p class="text-lg mb-4 text-green-100">
                        Sales & Service Cloud | Process Automation | Data Architecture | 7+ Years Experience
                    </p>
                    <p class="text-base md:text-lg mb-8 leading-relaxed text-green-50 max-w-4xl mx-auto">
                        I partner with organizations to design and implement <strong>Salesforce solutions that drive measurable business results</strong>. Specializing in <strong>Sales & Service Cloud, Process Automation, Data Architecture, and Customer Experience optimization</strong>, I build secure, scalable systems that improve operational efficiency, enhance team productivity, and deliver exceptional customer outcomes.
                    </p>
