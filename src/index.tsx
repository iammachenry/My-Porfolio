                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="flex flex-col justify-center order-2 lg:order-1" data-aos="fade-right">
                            ...
                            <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-4 md:mb-6 leading-tight text-white font-bold text-center lg:text-left">
                            ...
                            <p class="text-base sm:text-lg md:text-xl mb-6 md:mb-8 leading-relaxed text-white font-medium text-center lg:text-left">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                                <a href="#contact" class="bg-white text-green-700 px-6 py-3 sm:px-8 sm:py-4 rounded-full text-sm sm:text-base md:text-lg font-bold inline-flex items-center justify-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                                    Let's Discuss Your Project
                                </a>
                                <a href="#completed-projects" class="bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full text-sm sm:text-base md:text-lg font-bold inline-flex items-center justify-center hover:bg-white/20 transition shadow-2xl hover:scale-105 transition-all duration-300">
                                    View My Work
                                </a>
                            </div>
                        </div>
