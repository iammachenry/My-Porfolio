                ...
                <div class="text-center mb-8" data-aos="fade-down">
                    <div class="inline-block">
                        <div class="relative">
                            ...
                            <!-- Floating Badge -->
                            <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-white rounded-full px-5 py-2 shadow-xl">
                                <div class="flex items-center space-x-2">
                                    <div class="w-7 h-7 bg-gradient-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center">
                                        <i class="fas fa-cloud text-white text-sm"></i>
                                    </div>
                                    <span class="text-gray-900 font-bold text-sm">6X Salesforce Certified</span>
                                </div>
                            </div>
                        </div>
                    </div>
