                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl p-8 card-hover border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="text-gray-600 mb-6">
                            Day-to-day platform management including user setup, profiles, permission sets, and security configuration to keep systems running smoothly.
                        </p>
                    ...
                    <div class="bg-white rounded-2xl p-8 card-hover border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p class="text-gray-600 mb-6">
                            Built Flows to automate repetitive tasks like record updates, email alerts, and approvals. Saves teams time and cuts errors.
                        </p>
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-start text-sm text-gray-700">
                                <i class="fas fa-check text-green-600 mt-1 mr-2"></i>
                    ...
                    <div class="bg-white rounded-2xl p-8 card-hover border border-gray-100" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <p class="text-gray-600 mb-6">
                            Managed data imports, created custom objects and fields, and maintained data quality with validation rules and duplicate management.
                        </p>
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-start text-sm text-gray-700">
                                <i class="fas fa-check text-green-600 mt-1 mr-2"></i>
                    ...
                    <div class="bg-white rounded-2xl p-8 card-hover border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="text-gray-600 mb-6">
                            Created custom reports and dashboards to track key metrics, giving teams visibility into sales pipelines, case queues, and performance.
                        </p>
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-start text-sm text-gray-700">
                                <i class="fas fa-check text-green-600 mt-1 mr-2"></i>
                    ...
                    <div class="bg-white rounded-2xl p-8 card-hover border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p class="text-gray-600 mb-6">
                            Configured and maintained Sales Cloud (leads, opportunities) and Service Cloud (cases, queues, SLAs) to support daily business operations.
                        </p>
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-start text-sm text-gray-700">
                                <i class="fas fa-check text-green-600 mt-1 mr-2"></i>
