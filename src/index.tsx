                ...
                <div class="text-center mb-12" data-aos="fade-down">
                    <div class="inline-block">
                        <div class="relative">
                            ...
                            <div class="w-64 h-64 md:w-80 md:h-80 mx-auto rounded-full overflow-hidden border-8 border-white/20 shadow-2xl floating">
                                <img src="/static/henry-dashboard-photo.jpg" 
                                     alt="Henry Imafidon - Salesforce Administrator & Implementation Specialist" 
                                     class="w-full h-full object-cover">
                            </div>
                            <!-- Floating Badge -->
                            <div class="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-white rounded-full px-6 py-3 shadow-xl">
