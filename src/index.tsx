...
app.get('/', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <!-- Hero Section with Professional Photo and Dashboard Background -->
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="flex justify-center lg:justify-end" data-aos="fade-right">
                        <div class="relative">
                            ...
                            <!-- Badge Below Photo -->
                            <div class="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 rounded-full px-6 py-3 shadow-2xl badge-glow">
                    ...
                    <div class="text-white text-center lg:text-left" data-aos="fade-left">
                        <!-- Dramatic Multi-line Headline -->
                        <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                            I Design & Implement<br>
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-green-300">Enterprise-Grade Salesforce Solutions</span><br>
                            <span class="text-yellow-300">That Scale Operations & Elevate Customer Experience</span>
                        </h1>
                        
                        <!-- Brief Value Sentence -->
                        <p class="text-xl md:text-2xl mb-10 leading-relaxed text-white/90">
                        ...
                        <div class="flex flex-wrap gap-4 justify-center lg:justify-start">
                            <a href="#completed-projects" class="bg-gradient-to-r from-green-500 to-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold inline-flex items-center shadow-2xl hover:scale-105 transition-all duration-300">
                            ...
                            <a href="https://drive.google.com/file/d/1srpFAplJVJj4yO4mg4zWlYO2IfZdG-Ra/view?usp=sharing" 
                               target="_blank"
                               rel="noopener noreferrer"
                               class="bg-white text-gray-900 px-8 py-4 rounded-lg text-lg font-semibold inline-flex items-center hover:bg-gray-100 transition shadow-2xl hover:scale-105 transition-all duration-300">
