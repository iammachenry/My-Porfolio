        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 py-20 pt-24 md:pt-32">
                <div class="max-w-7xl mx-auto">
                    <!-- Your Professional Photo - LARGER SIZE -->
                    <div class="flex justify-center mb-6 md:mb-8" data-aos="fade-down">
                        <img 
                            src="/static/henry-salesforce-dashboard.jpg" 
                            alt="Henry Imafidon - Salesforce Administrator & Implementation Specialist" 
                            class="w-56 sm:w-64 md:w-80 lg:w-96 rounded-2xl shadow-2xl border-4 border-white/30"
                        />
                    </div>
                    
                    <!-- Value-Driven Sentence - BOLD & PROMINENT (WITH YELLOW HIGHLIGHTS) -->
                    <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-6 md:mb-8 leading-tight text-white max-w-4xl text-center mx-auto px-4 font-bold" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 md:mb-10 leading-relaxed text-white max-w-3xl text-center mx-auto px-4 font-medium" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <!-- Two Primary CTAs - STACK ON MOBILE, SMALLER PADDING -->
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4" data-aos="fade-up" data-aos-delay="250">
                        <a href="#completed-projects" class="bg-white text-green-700 px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-lg text-base md:text-lg font-semibold inline-flex items-center justify-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                            <i class="fas fa-folder-open mr-2 md:mr-3"></i>
                            View Projects
                        </a>
                        <a href="https://drive.google.com/file/d/1srpFAplJVJj4yO4mg4zWlYO2IfZdG-Ra/view?usp=sharing" 
                           target="_blank"
                           rel="noopener noreferrer"
                           class="bg-blue-600 text-white px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-lg text-base md:text-lg font-semibold inline-flex items-center justify-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
