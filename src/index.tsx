...
app.get('/', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <section id="home" class="relative min-h-[85vh] sm:min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <!-- Hero Content Overlay - TWO COLUMN LAYOUT (CONTENT LEFT, PHOTO RIGHT) -->
            <div class="relative z-10 w-full px-3 sm:px-6 lg:px-8 py-8 pt-20 md:pt-32 pb-12">
                <div class="max-w-7xl mx-auto">
                    <!-- Two Column Grid: Content Left, Photo Right -->
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        
                        <!-- LEFT: Content -->
                        <div class="flex flex-col justify-center order-2 lg:order-1" data-aos="fade-right">
                            <!-- Value-Driven Sentence (WITH YELLOW HIGHLIGHTS) -->
                            <h1 class="text-base sm:text-xl md:text-2xl lg:text-4xl mb-2 md:mb-5 leading-snug sm:leading-tight text-white font-bold text-center lg:text-left">
                            ...
                            <p class="text-xs sm:text-base md:text-lg lg:text-xl mb-4 md:mb-7 leading-snug sm:leading-relaxed text-white font-medium text-center lg:text-left">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center lg:justify-start">
                                <a href="#contact" class="bg-white text-green-700 px-5 py-2.5 sm:px-7 sm:py-4 rounded-lg text-sm sm:text-base md:text-lg font-bold inline-flex items-center justify-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                                    <i class="fas fa-comments mr-2 hidden sm:inline"></i>
                                    Get In Touch
                                </a>
                                <a href="#completed-projects" class="bg-blue-600 text-white px-5 py-2.5 sm:px-7 sm:py-4 rounded-lg text-sm sm:text-base md:text-lg font-bold inline-flex items-center justify-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
                                    <i class="fas fa-briefcase mr-2 hidden sm:inline"></i>
                                    View Projects
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-center lg:justify-start order-1 lg:order-2" data-aos="fade-left">
                            <img 
                                src="/static/henry-salesforce-dashboard.jpg" 
                                alt="Henry Imafidon - Salesforce Administrator & Implementation Specialist" 
                                class="w-52 sm:w-72 md:w-80 lg:w-96 rounded-2xl shadow-2xl border-4 border-white/30"
                            />
                        </div>
                ...
                <div class="mt-4 md:mt-12 flex justify-center">
                    <a href="#proven-results" class="text-white/70 hover:text-white transition animate-bounce">
                        <i class="fas fa-chevron-down text-lg md:text-3xl"></i>
                    </a>
                </div>
            </div>
        </section>
