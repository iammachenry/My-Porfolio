  ...
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <section id="home" class="pt-24 pb-20 gradient-bg">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-8" data-aos="fade-down">
                    <div class="inline-block">
                        <div class="relative">
                            <!-- Professional Photo - Optimal Size -->
                            <div class="w-44 h-44 md:w-56 md:h-56 mx-auto rounded-full overflow-hidden border-4 border-white/20 shadow-2xl floating">
                                <img src="/static/henry-dashboard-photo.jpg" 
                                     alt="Henry Imafidon - Salesforce Administrator & Implementation Specialist" 
                                     class="w-full h-full object-cover">
                            </div>
                            <!-- Floating Badge - Enhanced with Gradient, Glow & Animation -->
                            <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 rounded-full px-4 py-2 shadow-2xl badge-glow">
                                <div class="flex items-center space-x-2">
                                    <div class="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                                        <i class="fas fa-cloud text-blue-600 text-xs"></i>
                                    </div>
                                    <span class="text-white font-bold text-sm">6X Certified</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Hero Content - Centered Below Photo -->
                <div class="text-white text-center max-w-5xl mx-auto" data-aos="fade-up">
                    <!-- Dramatic Multi-line Headline -->
                    <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 leading-tight">
                        <span class="text-white">I Design & Implement</span><br>
                        <span class="text-white">Enterprise-Grade Salesforce Solutions</span><br>
                        <span class="text-yellow-300">That Scale Operations & Elevate Customer Experience</span>
                    </h1>
                    
                    <!-- Brief Value Sentence -->
                    <p class="text-xl md:text-2xl mb-10 leading-relaxed text-white max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-wrap gap-6 justify-center">
                        <a href="#completed-projects" class="btn-primary text-white px-10 py-5 rounded-lg text-lg font-semibold inline-flex items-center shadow-2xl hover:scale-105 transition-transform">
                        ...
                        <a href="https://drive.google.com/file/d/1srpFAplJVJj4yO4mg4zWlYO2IfZdG-Ra/view?usp=sharing" 
                           target="_blank"
                           rel="noopener noreferrer"
                           class="bg-white text-green-600 px-10 py-5 rounded-lg text-lg font-semibold inline-flex items-center hover:bg-green-50 transition shadow-2xl hover:scale-105 transition-transform">
            ...
            <section class="py-16 bg-gradient-to-br from-green-600 to-teal-700">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
