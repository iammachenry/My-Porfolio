        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 py-20 pt-24 md:pt-32">
                <div class="max-w-7xl mx-auto">
                    <!-- Your Professional Photo - SMALLER ON MOBILE -->
                    <div class="flex justify-center mb-6 md:mb-8" data-aos="fade-down">
                        <img 
                            ...
                            class="w-48 sm:w-56 md:w-64 lg:w-80 rounded-2xl shadow-2xl border-4 border-white/30"
                        />
                    </div>

                    <!-- Clean Professional Name - RESPONSIVE SIZING -->
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-4 text-white text-center mx-auto" data-aos="fade-up" data-aos-delay="100">
                        Henry Imafidon
                    </h1>
                    
                    <!-- Professional Roles - SMALLER ON MOBILE -->
                    ...
                    <!-- Value-Driven Sentence - COMPACT ON MOBILE -->
                    <p class="text-sm sm:text-base md:text-lg lg:text-xl mb-6 md:mb-8 leading-relaxed text-white max-w-4xl text-center mx-auto px-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4" data-aos="fade-up" data-aos-delay="300">
