                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="flex flex-col justify-center order-2 lg:order-1" data-aos="fade-right">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                                <a href="#contact" class="bg-white text-green-700 px-5 py-3 sm:px-7 sm:py-4 rounded-lg text-sm sm:text-base md:text-lg font-bold inline-flex items-center justify-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                                    <i class="fas fa-comments mr-2"></i>
                                    Get In Touch
                                </a>
                                <a href="#completed-projects" class="bg-blue-600 text-white px-5 py-3 sm:px-7 sm:py-4 rounded-lg text-sm sm:text-base md:text-lg font-bold inline-flex items-center justify-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
