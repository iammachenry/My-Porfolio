        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 pb-20 pt-32">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex justify-center mb-8" data-aos="fade-down">
                        <div class="relative">
                            ...
                            <div class="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                                <div class="inline-block bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 rounded-full px-6 py-3 shadow-2xl badge-glow">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                                            <i class="fas fa-cloud text-blue-600 text-base"></i>
                                        </div>
                                        <span class="text-white font-bold text-lg">6X Certified</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight text-white max-w-5xl text-center mx-auto mt-8" data-aos="fade-up" data-aos-delay="100">
                        I Design & Implement<br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-100">Enterprise-Grade Salesforce Solutions</span><br>
                        <span class="text-blue-100">That Scale Operations & Elevate Customer Experience</span>
                    </h1>
                    
                    <!-- Brief Value Sentence -->
                    <p class="text-xl md:text-2xl mb-12 leading-relaxed text-white/95 max-w-3xl text-center mx-auto" data-aos="fade-up" data-aos-delay="200">
