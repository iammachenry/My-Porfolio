        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 pb-20 pt-32">
                <div class="max-w-7xl mx-auto">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white text-center mx-auto" data-aos="fade-up" data-aos-delay="100">
                        Henry Imafidon
                    </h1>
                    
                    <!-- Professional Roles -->
                    <p class="text-xl md:text-2xl lg:text-3xl mb-8 leading-relaxed text-yellow-300 text-center mx-auto font-semibold" data-aos="fade-up" data-aos-delay="150">
