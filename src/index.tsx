        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 py-20 pt-24 md:pt-32">
                <div class="max-w-7xl mx-auto">
                    ...
                    <!-- Value-Driven Sentence - BOLD & PROMINENT (ABOVE ROLES) -->
                    <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-4 md:mb-6 leading-tight text-white max-w-4xl text-center mx-auto px-4 font-bold" data-aos="fade-up" data-aos-delay="100">
                        Helping organizations scale operations, improve customer experience, and drive efficiency through well-architected Salesforce solutions.
                    </h1>
                    
                    <!-- Professional Roles - BELOW VALUE SENTENCE -->
                    <p class="text-base sm:text-lg md:text-xl lg:text-2xl mb-4 md:mb-6 leading-relaxed text-yellow-300 text-center mx-auto font-semibold px-2" data-aos="fade-up" data-aos-delay="150">
                        CX Specialist | Salesforce Administrator | Implementation Consultant
                    </p>
                    
                    <!-- Brief Personal Intro -->
                    <p class="text-sm sm:text-base md:text-lg mb-6 md:mb-8 leading-relaxed text-white/90 max-w-3xl text-center mx-auto px-4" data-aos="fade-up" data-aos-delay="200">
                        I'm Henry Imafidon, a certified Salesforce Admin & Implementation Consultant and CX professional who transforms complex business challenges into streamlined, scalable solutions that drive measurable results.
                    </p>
