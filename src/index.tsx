  ...
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 to-teal-700">
            ...
            <!-- Hero Content Overlay - MOBILE OPTIMIZED (COMPACT) -->
            <div class="relative z-10 w-full px-3 sm:px-6 lg:px-8 py-16 pt-20 md:pt-32">
                <div class="max-w-7xl mx-auto">
                    <!-- Your Professional Photo - MOBILE COMPACT -->
                    <div class="flex justify-center mb-4 md:mb-8" data-aos="fade-down">
                        <img 
                            src="/static/henry-salesforce-dashboard.jpg" 
                            alt="Henry Imafidon - Salesforce Administrator & Implementation Specialist" 
                            class="w-48 sm:w-56 md:w-80 lg:w-96 rounded-2xl shadow-2xl border-4 border-white/30"
                        />
                    </div>
                    
                    <!-- Value-Driven Sentence - COMPACT ON MOBILE (WITH YELLOW HIGHLIGHTS) -->
                    <h1 class="text-lg sm:text-xl md:text-3xl lg:text-4xl mb-4 md:mb-6 leading-tight text-white max-w-4xl text-center mx-auto px-2 font-bold" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <!-- Brief Personal Intro - SMALLER ON MOBILE (WITH YELLOW HIGHLIGHTS) -->
                    <p class="text-sm sm:text-base md:text-lg lg:text-xl mb-6 md:mb-8 leading-relaxed text-white max-w-3xl text-center mx-auto px-2 font-medium" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <!-- Two Primary CTAs - COMPACT ON MOBILE -->
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-2" data-aos="fade-up" data-aos-delay="200">
                        <a href="#completed-projects" class="bg-white text-green-700 px-5 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-lg text-sm sm:text-base md:text-lg font-semibold inline-flex items-center justify-center shadow-2xl hover:scale-105 hover:shadow-3xl transition-all duration-300">
                            <i class="fas fa-folder-open mr-2"></i>
                            View Projects
                        </a>
                        <a href="#services" class="bg-blue-600 text-white px-5 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-lg text-sm sm:text-base md:text-lg font-semibold inline-flex items-center justify-center hover:bg-blue-700 transition shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <!-- Scroll Indicator - COMPACT ON MOBILE -->
                <div class="mt-6 md:mt-12 flex justify-center">
                    <a href="#proven-results" class="text-white/70 hover:text-white transition animate-bounce">
                        <i class="fas fa-chevron-down text-xl md:text-3xl"></i>
                    </a>
                </div>
            </div>
        </section>
